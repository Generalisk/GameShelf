...
internal class OculusLibrary : Library<OculusGame, OculusHandler>
{
    ...
    protected override OculusHandler GetHandler()
    {
        Console.WriteLine("Initializing Oculus Handler...");
        ...
        Console.WriteLine("Oculus Handler Initialized!");

        return handler;
    }

    public override OculusGame? Get(object id)
    {
        var gameid = OculusGameId.From(Convert.ToUInt64(id));
    ...
    public override OculusGame[] GetAll()
    {
        var games = new List<OculusGame>();
