...
internal class BattleNetLibrary : Library<BattleNetGame, BattleNetHandler>
{
    ...
    protected override BattleNetHandler GetHandler()
    {
        Console.WriteLine("Initializing Battle.net Handler...");
        ...
        var handler = new BattleNetHandler(fileSystem, registry);

        Console.WriteLine("Battle.net Handler Initialized!");

        return handler;
    }

    public override BattleNetGame? Get(object id)
    {
        var gameid = BattleNetGameId.From(id.ToString());
    ...
    public override BattleNetGame[] GetAll()
    {
